...
export default function EssentialTools() {
  ...
  const tools = [
    ...
    // 🌗 Light/dark logo switch for Express
    {
      name: "ExpressJS",
    ...
    // 🌗 Light/dark logo switch for MongoDB
    {
      name: "MongoDB",
    ...
    // 🌗 Light/dark logo switch for React
    {
      name: "React",
  ...
  return (
    ...
    >
      {/* Heading */}
      <h2
        className={`text-center text-2xl sm:text-3xl font-bold mb-4 leading-tight text-transparent bg-clip-text bg-gradient-to-r ${
          theme === "light"
      ...
      {/* Description */}
      <p
        className={`mb-8 max-w-2xl mx-auto text-center text-sm sm:text-base leading-tight text-transparent bg-clip-text bg-gradient-to-r ${
          theme === "light"
            ? "from-[#202016] to-gray-900"
      ...
      <div className="grid grid-cols-1 min-[360px]:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {tools.map((tool) => (
          <div
            key={tool.name}
            className={`p-4 rounded-lg transition-all duration-300 hover:shadow-lg flex flex-col items-center text-center ${
              theme === "light"
